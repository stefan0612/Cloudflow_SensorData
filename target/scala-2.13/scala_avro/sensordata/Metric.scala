...
case class Metric(var deviceId: java.util.UUID, var timestamp: java.time.Instant, var name: String, var value: Double) extends org.apache.avro.specific.SpecificRecordBase {
